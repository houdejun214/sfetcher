 ...
 *
 */
public class TencentFutureParser extends SenseParser {

	protected static Logger log = LoggerFactory.getLogger("Future.TencentFutureParser");
	...
	public TencentFutureParser(Configuration conf) {
		super(conf);
		tencentJsonParser = new TencentFutureJsonParser();
