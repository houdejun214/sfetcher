package com.sdata.sense.parser.weiboHot;
 ...
 *
 */
public class WeiboHotParser extends SenseParser {
	protected static Logger log = LoggerFactory.getLogger("Sense.WeiboHotParser");
	...
	public ParseResult parseCrawlItem(Configuration conf, RawContent rc,
		...
		RedisDB redisDB = CrawlDBRedis.getRedisDB(conf,"WeiboHot");
