 ...
 */
public class CommonDatumStorer extends SdataStorer {

    private static MysqlDataSource dataSource = null;

    private static Object sync = new Object();

    private static CommonDatumDao dao = null;

    public static CommonDatumDao getDataDao(){
        return dao;
    }

    public CommonDatumStorer(Configuration conf, RunState state){
        this.setConf(conf);
        this.init(conf);
        this.state = state;
    }
        ...
        if(dataSource==null){
            synchronized (sync) {
                if(dataSource==null){
                    ...
                    dao = new CommonDatumDao(dataSource);
                }
            }
        }
    }
