 ...
 *
 */
public class HBaseStore extends DBStore {
	
	protected StoreCollection storeCollection ;
	protected HBaseClient client;
	protected StatisticsStore statisStore;
	
	public HBaseStore(HBaseClient client,StoreCollection storeCollection){
