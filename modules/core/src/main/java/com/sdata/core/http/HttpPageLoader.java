...
import com.sdata.core.http.robots.RobotstxtConfig;
import com.sdata.core.http.robots.RobotstxtServer;
import com.sdata.core.http.url.URLCanonicalizer;
...
public class HttpPageLoader {
	...
	private void refinePage(HttpPage page){
		...
		if(StringUtils.isEmpty(page.getContentCharset())){
			...
			page.setContentHtml(EncodingUtil.getString(page.getContentData(), charset));
		}
	}
