...
import com.sdata.core.data.dao.ColumnFamily;
...
public class StoreConfig extends AbstractConfig{
	...
	private transient StoreCollection mainCollection;
	...
	protected void parse(Document document) {
		list = new ArrayList<StoreCollection>();
		Element root = document.getRootElement();
		Iterator<Element> iterator = root.elementIterator();
		while(iterator.hasNext()){
			Element next = (Element)iterator.next();
			StoreCollection collection = new StoreCollection(conf.get(Constants.SOURCE));
			// attribute
	...
	private void copyAttributeToCollection(StoreCollection collection,Element e) {
	...
	private void addChildren(StoreCollection collection,Element e) {
	...
	public Iterator<StoreCollection> getCollections() {
		return list.iterator();
	}

	public StoreCollection getMainCollection() {
		if(mainCollection == null){
			Iterator<StoreCollection> iterator = list.iterator();
			while(iterator.hasNext()){
				StoreCollection sc = iterator.next();
