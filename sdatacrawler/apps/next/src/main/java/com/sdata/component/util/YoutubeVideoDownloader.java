...
public class YoutubeVideoDownloader {
	...
	private static final Logger log = Logger
			.getLogger(YoutubeVideoDownloader.class.getCanonicalName());
...
//			usage("Missing video id. Extract from http://www.youtube.com/watch?v=VIDEO_ID");
		...
		try {
			...
			log.fine("Starting");
			String videoId = "tcNAVnEgwzk";
			String outdir = "F://youtube/";
			...
			play(videoId, encoding, userAgent, outputDir, extension);
	...
	private static void play(String videoId, String encoding,
