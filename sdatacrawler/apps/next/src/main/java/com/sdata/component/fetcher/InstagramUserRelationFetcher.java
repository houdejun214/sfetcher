...
public class InstagramUserRelationFetcher extends SdataFetcher {
	
	private InstagramUserRelationCircularAreaIterator iterator;
	
	private InstagramApi api;
	
	private static final Logger log = LoggerFactory.getLogger("SdataCrawler.InstagramFetcher");
	
	public InstagramUserRelationFetcher(Configuration conf,RunState state) {
		this.setConf(conf);
		this.setRunState(state);
		api = new InstagramApi(conf);
		parser = new InstagramParser(conf,state);
		iterator = new InstagramUserRelationCircularAreaIterator(conf,state);
	}
 ...
 */
class InstagramUserRelationCircularAreaIterator {
	...
	public InstagramUserRelationCircularAreaIterator(Configuration conf,RunState state) {
