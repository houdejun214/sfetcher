...
public class InstagramSearchAPI{
	...
	private static final Logger log = LoggerFactory.getLogger("SdataCrawler.InstagramSearchAPI");
	...
	public InstagramSearchAPI(Date confStartTime,Date confEndTime){
