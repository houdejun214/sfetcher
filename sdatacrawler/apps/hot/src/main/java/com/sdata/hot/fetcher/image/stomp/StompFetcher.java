package com.sdata.hot.fetcher.image.stomp;
 ...
 *
 */
public class StompFetcher extends HotImageFetcher {

	protected static Logger log = LoggerFactory.getLogger("Hot.StompListFetcher");
