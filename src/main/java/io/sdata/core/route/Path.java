...
final class Path {
    ...
    public Path(String path) {
        this.path   = StringUtils.trim(Preconditions.checkNotNull(path, "path"), "/");
        this.paths = StringUtils.split(this.path, "/");
        this.antPathPattern = PARAM_PATTERN.matcher(this.path).replaceAll("*");
     ...
     */
    public boolean match(String queryPath, Map<String, String> params) {
        if (doMatch(this.antPathPattern, queryPath, false)){
            if (params != null){
